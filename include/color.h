...
/// Get the color's foreground, ignoring BOLD
#define GetFore(color) ((color & ~BOLD) / COLORS_STEP)
/// Get the color's background, ignoring BOLD
#define GetBack(color) ((color & ~BOLD) % COLORS_STEP)
